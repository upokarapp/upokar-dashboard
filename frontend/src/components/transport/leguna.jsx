...
import { getAllLegunaOrder, deleteLegunaOrder } from '../../Api';
...
const OrderTable = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await getAllLegunaOrder();
            setOrders(response);
            setLoading(false);
        } catch (err) {
                    ...
                    {filteredOrders.length === 0 ? (
                        ...
                        filteredOrders.map((order, index) => (
                            <div className="table-row" key={index}>
                                ...
                                <div data-label="Leguna Type">{order.truckType}</div>
                                <div data-label="Load Weight">{order.loadWeight} kg</div>
