...
import { getAllPharmacy, deletePharmacy } from "../../Api"
import { Link } from 'react-router-dom';
import Spinner from "../loader"
import './showPharmacy.css';
...
const OrderTable = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await getAllPharmacy();
            setOrders(response);
            setLoading(false);
        } catch (err) {
        ...
        <div id='pharmacy-table'>
            <div className="order-table-container" >
                <div className="search-container">
                    ...
                    />
                    <div>
                        <Link to='/addPharmacy' className="btn primary">Add </Link>
                    </div>
                </div>
                ...
                <div className="table-responsive">
                    ...
                    {filteredOrders.length === 0 ? (
                        <div className="no-results">No Pharmacy found</div>
                    ) : (
            ...
            {deleteConfirm && (
                <div className="confirmation-modal">
                    <div className="modal-content">
                        ...
                        <p>Are you sure you want to delete this Pharmacy? This action cannot be undone.</p>
