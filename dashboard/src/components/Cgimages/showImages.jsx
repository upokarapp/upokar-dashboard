...
import { getAllGrocarySliderImages, createGrocarySliderImage, updateGrocarySliderImage, deleteGrocarySliderImage } from '../../Api';
import '../Cimages/ImageGallery.css';
...
const ImageGallery = () => {
    ...
    const fetchImages = async () => {
        setLoading(true);
        try {
            const res = await getAllGrocarySliderImages();
            setImages(res);
        } catch (err) {
    ...
    const handleUpload = async (e) => {
        ...
        setLoading(true);
        try {
            await createGrocarySliderImage(formData);
            fetchImages();
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            setLoading(true);
            await updateGrocarySliderImage(formData);
            fetchImages();
    ...
    const handleDelete = async () => {
        try {
            setLoading(true);
            await deleteGrocarySliderImage({ _id: deletingImage._id, id: deletingImage.id });
            fetchImages();
